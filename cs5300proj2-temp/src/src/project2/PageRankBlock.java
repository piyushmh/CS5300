...
public class PageRankBlock {
	...
	public static void main(String[] args) throws Exception {
        ...
        do {
            ...
            job.setJarByClass(src.project2.PageRankBlock.class);

            // Set Mapper and Reducer class
            job.setMapperClass(src.project2.PageRankBlockMapper.class);
            job.setReducerClass(src.project2.PageRankBlockReducer.class);
